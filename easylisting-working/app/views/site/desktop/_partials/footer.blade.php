                ...
                <div class="row">
                    ...
                    <article class="col-xs-3">
                        ...
                        <ul class="list-unstyled list-links">
                            ...
                            <li><a href="{{ URL::to(App::getLocale().'/p/faq') }}">FAQ</a></li>
...
<!--                             <li>
                            ...
                            <li>
                                <a href="#subscribe" data-toggle="modal" data-target="#modal-subscribe-form">
...
@include('site.desktop.homepage.subscribe_newsletter')