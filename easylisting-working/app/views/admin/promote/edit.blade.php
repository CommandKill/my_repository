...
<div class="row">
    <div class="col-xs-12">
		...
		{{ Form::open(array('url' => array('admin/content-promote/update', $data['page']->id), 'method' => 'post', 'files' => true)) }}
        <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <a href="{{ URL::to('admin/content-promote') }}">Back to all promote</a>
...
@include('admin.promote.preview-modal')
@stop
@section('footer')
...
$(function(){
  ...
  $('#thumbnail').fileupload({
    url: '{{ URL::to('admin/content-promote/file-thumbnail') }}',
