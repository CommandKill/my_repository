...
<div class="row">
    <div class="col-xs-12">
		...
		{{ Form::open(array('url' => array('admin/page/update', $data['page']->id), 'method' => 'post', 'files' => true)) }}
        <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <a href="{{ URL::to('admin/page') }}">Back to all page</a>
...
@include('admin.page.preview-modal')
@stop
@section('footer')
