...
<div class="panel panel-default">
	<div class="panel-heading">
		<a href="#modal-content" class="btn btn-primary btn-sm btn-add" data-toggle='modal' role='button'> Add new blog</a>
	</div>
	...
	<form class="form-inline" role="form">
		...
		<a href="{{ URL::to('admin/blog') }}" class="alert-link">Reset</a>
	</form>
	</div>
</div>
	...
	<tbody>
	  ...
	  <tr>
	    <td>{{ $page['id'] }}</td>
	    <td>{{ Str::limit($page->title, 50) }}<br/><small>( {{ $page['slug'] }} )</small></td>
	    <td>
	    ...
	    <td>
	      <div class="btn-group">
	        <a href="{{ URL::to('admin/content-blog/edit') }}/{{ $page->id }}" type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
	...
	<div class="alert alert-dismissable alert-warning" style="margin:10px">
		...
		<h4>Empty data!</h4>
		<p>Please check your data again, or <a href="{{ URL::to('admin/content-blog') }}" class="alert-link">Reset</a>.</p>
	</div>
	@endif


@include('admin.blog.add-modal')
