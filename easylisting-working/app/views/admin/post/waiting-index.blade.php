  ...
  <table class="table table-hover ">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <div class="btn-group">
            <a href="{{ URL::to('admin/post/approve') }}/{{ $post->id }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-ok"></span> Approve</a>
            <a href="{{ URL::to('admin/post/disapprove') }}/{{ $post->id }}" class="btn btn-default btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Disapprove</a>
          </div>
