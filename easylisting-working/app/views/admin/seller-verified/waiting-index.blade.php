    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <img src="{{ sprintf($data['thumbnail_url'], $post->member_id, $post->id_docs) }}" alt="..." class="" data-toggle="modal" data-target="#modal-large-image-{{ $post->id }}">

          <?php $_large = $post->member_id.'/'.$post->id_docs; ?>

          <!-- Modal -->
          <div class='modal fade' id='modal-large-image-{{ $post->id }}' tabindex='-1'>
                ...
                <div class='modal-content'>
                    <div class='modal-body' style="min-height:500px; overflow: auto;">
                         <div class="col-xs-12 no-padding">
                            <img src="{{ $data['thumbnail_large'] }}{{ $_large }}" alt="..." class="" width="100%">
                        </div>
                    </div>
                </div>
