...
<div class="panel panel-default">
	<div class="panel-heading">
		<a href="#modal-content" class="btn btn-primary btn-sm btn-add" data-toggle='modal' role='button'> Add new review</a>
	</div>
	...
	<form class="form-inline" role="form">
		...
		<a href="{{ URL::to('admin/content-review') }}" class="alert-link">Reset</a>
	</form>
	</div>
</div>
	...
	<tbody>
	  ...
	  <tr>
	    ...
	    <td>
	      <div class="btn-group">
	        <a href="{{ URL::to('admin/content-review/edit') }}/{{ $page->id }}" type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
	...
	<div class="alert alert-dismissable alert-warning" style="margin:10px">
		...
		<h4>Empty data!</h4>
		<p>Please check your data again, or <a href="{{ URL::to('admin/content-review') }}" class="alert-link">Reset</a>.</p>
	</div>
	@endif


@include('admin.review.add-modal')
